...
const ChatPanel = ({ messages, onSendMessage, onChatMessage, isGenerating = false, onNewProject, streamingText = '', projectId, onAnalyze, onClearChat, onStop }) => {
  ...
  return (
    <div className="w-full flex-1 md:flex-none md:w-96 md:h-full shrink-0 border-b md:border-b-0 md:border-r border-gray-800 flex flex-col bg-[#0f0f0f] min-h-0" data-testid="chat-panel">
      {/* Header */}
